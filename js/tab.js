		...
		if(team!=$(this).attr('heis')){
            ...
            //        	 teamContext+= hashT[j]+"<br>";
            	...
            	for(var i=0;i<hash.length;i++){
                    ...
                    //teamContext+="<img style=\"background:url(img/student/"+ hashD[0]+"/00.jpg);\" heis=\""+ hashD[0]+"\" class=\"icon\">";
                    teamContext+="<img src=\"img/student/"+ hashD[0]+"/00.jpg\" heis=\""+ hashD[0]+"\" class=\"icon\">";
                    teamContext+="</a>";
                    teamContext+="</div>";
                    teamContext+="<div>";
